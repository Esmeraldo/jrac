...
(function( $ ){
    ...
    $.fn.jrac = function(options) {
        ...
        var settings = {
            ...
            //If the property "zoom_max" is the value "width" or "height" will be used this value of the original image of the property informed.
            'zoom_max': 3000,

            //The property information will be able to move the image.
            'image_drag': false,

            //The property information can resize the viewport.
        ...
        return this.each(function() {
            ...
            //Get the value of zoom_max
            switch (settings.zoom_max) {
                case 'width':
                    settings.zoom_max = $image.width();
                    break;
                case 'height':
                    settings.zoom_max = $image.height();
                    break;
            }
            ...
            $('<img>').attr('src', $image.attr('src')).load(function(){
                ...
                $image.css({
                    'left': settings.viewport_content_left,
                    'top': settings.viewport_content_top
                });
